...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// The nested function can access the variables inside of the nested function because of scope. The nested function has access to all the variables inside the nested function and all variables above it. 
...
const zooAnimals = [
  ...
  */
  function animalNames(animals){
    ...
    animals.forEach(animal => {
      anim.push(`name: ${animal["animal_name"]}, scientific: ${animal["scientific_name"]}`)
    })
    return anim;
  }
  ...
  */
  function lowPopulationAnimals(animals){
    const lowPopulationAnimals = animals.filter(animal => {
  ...
  */
  function USApop(animals){
    const total = animals.reduce((acc, current) => {
